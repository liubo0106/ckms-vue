<template>
    <section>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{ path: '/outstockreport' }">出库单报表统计</el-breadcrumb-item>
            <el-breadcrumb-item>出库单详情报表统计</el-breadcrumb-item>
        </el-breadcrumb>
...
<script type="text/ecmascript-6">
    import {requestOutStockOrderReportDetailPage, requestUrl} from '../../api/api';

    export default {
        name: 'merchant',
        data() {
            return {
                pid:sessionStorage.getItem('outStockReportId'),
                loading: false,
                searchForm: {
                    time:'',
                    pid:sessionStorage.getItem('outStockReportId'),
        ...
        methods: {
            ...
            handleSizeChange(val){
                ...
                requestOutStockOrderReportDetailPage(_this.param).then(res => {
                    _this.loading = false;
            ...
            handleClick(index, row, doType) {
                ...
                if(doType == 'export') {
                    ...
                    location.href = requestUrl+'export/outStockDetailReport'+
                        '?beginDate='+beginDate+
                        '&endDate='+endDate+
