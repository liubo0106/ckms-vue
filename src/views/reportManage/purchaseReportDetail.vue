<template>
    <section>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{ path: '/purchasereport' }">采购单报表统计</el-breadcrumb-item>
            <el-breadcrumb-item>采购单详情报表统计</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="contentBody" style="padding-bottom: 0px">
            <el-form :model="searchForm" inline ref="ruleForm" label-width="100px" label-position="left">
                ...
                <el-form-item label="供应商名称" prop="supplierId">
                    <el-select v-model="searchForm.supplierId" clearable filterable placeholder="请选择" @change="changeSelect" class="min-width-select">
...
<script type="text/ecmascript-6">
    import {requestPurchaseReportDetailPage, requestSearchSupplier, requestUrl} from '../../api/api';

    export default {
        name: 'merchant',
        data() {
            return {
                pid:sessionStorage.getItem('purchaseReportId'),
                loading: false,
                searchForm: {
                    time:'',
                    pid:sessionStorage.getItem('purchaseReportId'),
        ...
        methods: {
            ...
            handleSizeChange(val){
                ...
                requestPurchaseReportDetailPage(_this.param).then(res => {
                    _this.loading = false;
            ...
            handleClick(index, row, doType) {
                ...
                if(doType == 'export') {
                    ...
                    location.href = requestUrl+'export/purchaseDetailReport'+
                        '?beginDate='+beginDate+
                        '&endDate='+endDate+
            ...
            onSearch() {
                ...
                this.param.supplierId = this.searchForm.supplierId;
                if(this.searchForm.time && this.searchForm.time.length>0){
            ...
            getAjaxSupplier(){
                let _this = this;
                requestSearchSupplier(_this.paramSupplier).then(res => {
                    let data = res.data.items;
                    if(data && data.length>0){
