<template>
    <section>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>出库单报表统计</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="contentBody" style="padding-bottom: 0px">
            <el-form :model="searchForm" inline ref="ruleForm" label-width="100px" label-position="left">
                ...
                <el-form-item label="领用门店" prop="customerId">
                    <el-select v-model="searchForm.customerId" clearable filterable placeholder="请选择" @change="changeSelect" class="min-width-select">
        ...
        <div class="contentBody" v-loading="loading"
            ...
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column align="center" header-align='center' prop="orderNo" label="出库单号"></el-table-column>
                ...
                <el-table-column align="center" header-align='center' prop="totalPrice" label="总价"></el-table-column>
                ...
                <el-table-column align="center" header-align='center' label="操作" width="100">
                    <template slot-scope="scope">
                        <el-button size="mini" style="background-color: #f37276;color: #fff;border: none;" @click="handleClick(scope.$index, scope.row, 'detail')">详情</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
...
<script type="text/ecmascript-6">
    import {requestOutStockOrderReportPage, requestSearchClient, requestUrl} from '../../api/api';
    ...
    export default {
        ...
        methods: {
            ...
            handleSizeChange(val){
                ...
                requestOutStockOrderReportPage(_this.param).then(res => {
                    _this.loading = false;
            ...
            handleClick(index, row, doType) {
                ...
                if(doType == 'export') {
                    ...
                    location.href = requestUrl+'export/outStockOrderReport'+
                        '?beginDate='+beginDate+
                        '&endDate='+endDate+
                    ...
                    sessionStorage.setItem('outStockReportId', row.id);
                    this.$router.push({ path: '/outstockreportdetail'});
                }
            },
            onSearch() {
                this.param.pageNo = 1;
                ...
                this.param.customerId = this.searchForm.customerId;
                if(this.searchForm.time && this.searchForm.time.length>0){
            ...
            getAjaxClient(){
                let _this = this;
                requestSearchClient(_this.customerParam).then(res => {
                    let data = res.data.items;
                    if(data && data.length>0){
