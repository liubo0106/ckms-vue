        ...
        <div class="contentBody">
            <el-form inline>
                <el-form-item label="商品名称">
                    <el-input v-model="searchForm.productInfoName"></el-input>
                </el-form-item>
...
<script>
    import {requestReportrawProdReport, requestUrl} from "../../api/api";
    ...
    export default {
        ...
        methods:{
            ...
            getAjaxPage(){
                ...
                requestReportrawProdReport(this.searchForm).then((res)=>{
                    if(res.status==200){
            ...
            handleClick(type){
                ...
                if(type=='export'){
                    this.searchForm.endDate=this.dataTime[1];
                    this.searchForm.beginDate=this.dataTime[0];
                    location.href = requestUrl+'export/rawProdReportExport'+'?beginDate='+this.searchForm.beginDate+
