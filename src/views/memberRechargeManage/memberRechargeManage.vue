    ...
    <section>
        ...
        <div class="contentBody">
            ...
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column align="center" header-align='center' prop="amount" label="金额" width="110"></el-table-column>
                ...
                <el-table-column align="center" header-align='center' label="操作" width="240">
                    <template slot-scope="scope">
                        ...
                        <el-button v-if='scope.row.status == 1' size="mini" @click="handleClick(scope.$index, scope.row, 'edit')">编辑</el-button>
...
<script type="text/ecmascript-6">
    import { requestSearchMember, requestDeleteMember,requestMember} from '../../api/api';//requestSearchSupplier
    export default {
        name: 'user-manage',
        ...
        methods: {
            ...
            handleClick(index, row, doType) {
                ...
                if(doType == 'delete'){
                    ...
                    this.$router.push({ path: '/editMemberRecharge'});
                }else if(doType == 'edit'){
