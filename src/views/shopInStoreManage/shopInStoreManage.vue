<template>
    <section>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>门店入库管理</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="contentBody"
            ...
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column align="center" header-align='center' prop="orderNo" label="入库单号" width="160"></el-table-column>
...
<script type="text/ecmascript-6">
    import { requestShopInStockOrderPage, requestDeleteShopInStockOrder,requestStatusShopIn} from '../../api/api';
    export default {
        name: 'user-manage',
        data() {
            return {
        ...
        methods: {
            ...
            handleSizeChange(val){
                ...
                requestShopInStockOrderPage(_this.param).then(res => {
            ...
            handleClick(index, row, doType) {
                ...
                if(doType == 'delete'){
                    this.$confirm('真的删除该行数据么, 是否继续?', '提示', {
                        ...
                        requestDeleteShopInStockOrder(deleteParam).then(res => {
                            this.$message({
                                type: 'success',
                                message: '删除成功!',
                                duration:300,
                    ...
                    this.$router.push({ path: '/editShopInStock'});
                }else if(doType == 'edit'){
                    sessionStorage.setItem('inId', row.id);
                    this.$router.push({ path: '/editShopInStock'});
                }else if(doType == 'detail'){
                    sessionStorage.setItem('inId', row.id);
                    this.$router.push({ path: '/detailShopInStock'});
                }if(doType == 'ok'){
                    this.$confirm('是否确认该入库单?', '提示', {
                        ...
                        requestStatusShopIn(sParam).then(res => {
                            this.$message({
                                type: 'success',
                                message: '操作成功!',
                                duration:300,
