        ...
        <div class="contentBody">
            <el-form :model="editForm" :rules="rules" ref="editForm" label-width="100px" class="demo-ruleForm">
                <el-form-item label="供应商" prop="name">
                        <el-input placeholder='请输入' v-model="editForm.name" :maxlength="25" disabled></el-input>
                </el-form-item>
                <el-form-item label="联系人" prop="contact">
                    <el-input placeholder='请输入' v-model="editForm.contact" :maxlength="15" disabled></el-input>
                </el-form-item>
                <el-form-item label="电话" prop="phone">
                    <el-input placeholder='请输入' v-model="editForm.phone" :maxlength="11" disabled></el-input>
                </el-form-item>
                <el-form-item label="地址" prop="address">
                    <el-input placeholder='请输入' v-model="editForm.address" :maxlength="50" disabled></el-input>
                </el-form-item>
                <el-form-item label="供应内容" prop="content">
                    <el-input placeholder='请输入供应内容' v-model="editForm.content" :maxlength="100" disabled></el-input>
                </el-form-item>
                <el-form-item>
