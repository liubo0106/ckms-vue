...
<script type="text/ecmascript-6">
    import { requestSalesOrderInfo, requestSaveSalesOrder,requestSearchClient,requestListBySalesPid, requestDeleteSalesDetail,requestSaveSalesDetail,requestSearchProductList} from '../../api/api';
    export default {
