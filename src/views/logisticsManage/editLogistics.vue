        ...
        <div class="contentBody">
            <el-form :model="editForm" :rules="rules" ref="editForm" label-width="100px" class="demo-ruleForm">
                <el-form-item label="车牌号" prop="plateNumber">
                    <el-input placeholder='请输入' v-model="editForm.plateNumber" :maxlength="20"></el-input>
                </el-form-item>
                ...
                <el-form-item label="公司名称" prop="company">
                    <el-input placeholder='请输入' v-model="editForm.company" :maxlength="50"></el-input>
                </el-form-item>
                <el-form-item>
...
<script type="text/ecmascript-6">
    import { requestLogisticsInfo, requestSaveLogistics,} from '../../api/api';
    export default {
        ...
        methods: {
            requestLogisticsInfo(){
                let _this = this;
                requestLogisticsInfo({id:this.id}).then(res => {
                    if(res.status == 200){
                        let data = res.data;
                        if (data) {
                            _this.editForm.plateNumber = data.plateNumber;
                            _this.editForm.contact = data.contact;
                            _this.editForm.phone = data.phone;
                            _this.editForm.company = data.company;
                        }
                    }else{
                        this.$message({
                            message: '请求异常',
            ...
            goBack() {
                this.$router.push({ path: '/logisticsManage' });
            },
            submitForm(formName){
                let _this = this;
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        let editFormParam ={
                            plateNumber: _this.editForm.plateNumber,
                        ...
                        requestSaveLogistics(editFormParam).then(res => {
                            this.$message({
                                type: 'success',
                                message: '操作成功!',
                                duration:300,
