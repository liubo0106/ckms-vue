<template>
    <section>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item :to="{ path: '/salesOrder' }">门店订单管理</el-breadcrumb-item>
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="订单日期">
                            <el-date-picker type="date" disabled placeholder="选择日期" v-model="editForm.dateTime"  value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="总量" style="width: 316px">
                            <el-input placeholder='请输入' disabled v-model="editForm.totalNumber" :maxlength="200"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="总价" style="width: 316px">
                            <el-input placeholder='请输入' disabled v-model="editForm.totalPrice" :maxlength="200"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-form-item label="备注">
                    <el-input type="textarea"  disabled v-model="editForm.remark" :maxlength="200"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" @click="handleClick('', '', 'export')">导出数据</el-button>
                </el-form-item>
            </el-form>
            <!--采购单明细-->
...
<script type="text/ecmascript-6">
    import { requestSalesOrderInfo, requestSaveSalesOrder,requestSearchClient,requestListBySalesPid, requestDeleteSalesDetail,requestSaveSalesDetail,requestSearchProductList,requestUrl} from '../../api/api';
    export default {
        ...
        methods: {
            ...
            handleClick(type){
                if(type='export'){
                    //导出
                    //${requestUrl}
                    location.href=`${requestUrl}/export/salesDetailReport?pid=${this.param2.pid}`;
                }
            },
            ...
            goBack() {
                this.$router.push({ path: '/shopOrderManage' });
            },
            /*销售单主表*/
            submitForm(formName){
                let _this = this;
