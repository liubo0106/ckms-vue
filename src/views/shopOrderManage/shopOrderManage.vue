<template>
    <section>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>门店订单管理</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="contentBody">
            ...
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column align="center" header-align='center' prop="dateTime" label="订单日期" width="140"></el-table-column>
                ...
                <el-table-column align="left" header-align='center' label="操作" width="95">
                    <template slot-scope="scope">
                        ...
                        <!--<el-button v-if='scope.row.status == 0' size="mini" type="primary" @click="handleClick(scope.$index, scope.row, 'edit')">编辑</el-button>-->
...
<script type="text/ecmascript-6">
    import { requestSalesOrderPage, requestDeleteSalesOrder,requestSalesOrder} from '../../api/api';
    export default {
        name: 'user-manage',
        data() {
            return {
        ...
        methods: {
            ...
            handleClick(index, row, doType) {
                ...
                if(doType == 'delete'){
                    ...
                    sessionStorage.setItem('sId', row.id);
                    this.$router.push({ path: '/detailShopOrder'});
                }if(doType == 'ok'){
                    this.$confirm('是否确认该门店订单?', '提示', {
                        confirmButtonText: '确定',
                        cancelButtonText: '取消',
                        type: 'warning'
                    }).then(() => {
