<template>
    <section>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item :to="{ path: '/recombination' }">门店商品重组</el-breadcrumb-item>
        ...
        <div class="contentBody">
            ...
            <el-form :model="editForm" :rules="rules" ref="editForm" label-width="100px" class="demo-ruleForm">
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="商品名称" prop="num" style="width:517px">
                            <el-input v-model="editForm.name" disabled/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item  label="菜品分类" prop="categoryId">
                            <el-select  v-model="editForm.categoryId" placeholder="请选择" @change="changeCategory" style="width:417px;" disabled>
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="商品编号"  style="width: 416px;">
                            <el-input v-model="editForm.serialNo"  style="width: 416px;" disabled></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="单位"  style="width: 416px;">
                            <el-input v-model="editForm.standard"  style="width: 416px;" disabled></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
...
<script type="text/ecmascript-6">
    import {
        ...
        requestRecombinationSave,
        requestRecombinationPage,
        requestRecombinationDelete,
    } from '../../api/api';
    ...
    export default {
        ...
        methods: {
            ...
            handleClickDetail(index, row, doType) {
                ...
                if(doType == 'delete'){
                    _this.$confirm('真的删除该行数据么, 是否继续?', '提示', {
                        ...
                        requestRecombinationDelete(deleteParam).then(res => {
                            if(res.status == 200){
                                _this.$message({
                                    type: 'success',
                                    message: '删除成功!',
            ...
            handleClickTreeAdd3(index,row) {
                ...
                if(this.tableData.length!=0){
                    for(let i=0;i<this.tableData.length;i++){
                        if(row.id==this.tableData[i].storeGoodsId){
                            numberData=this.tableData[i].number;
                            id=this.tableData[i].id;
                        }
                    }
                    number=numberData+this.tableTreeData3[index].number;
                }else{
                ...
                requestRecombinationSave(addParam).then(res => {
                    if (res.status == 200) {
                        _this.$message({
                            type: 'success',
                            message: '操作成功!',
            ...
            getAjaxList(){
                let _this = this;
                requestRecombinationPage({parentId:_this.id}).then(res => {
                    _this.tableData = [];
                    let data = res.data.items;
                    if(data && data.length>0){
            ...
            goBack() {
                this.$router.push({ path: '/recombination' });
            },
