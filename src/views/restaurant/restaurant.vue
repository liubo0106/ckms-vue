    ...
    <section>
        ...
        <div class="contentBody"
            ...
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column align="left" header-align='center' label="操作" width="460">
                    <template slot-scope="scope">
                        ...
                        <el-button icon="el-icon-check" v-if='scope.row.status != 1'  size="mini" type="danger" @click="handleClick(scope.$index, scope.row, 'ok')">确定</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
